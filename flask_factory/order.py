        ...
        with db.get_data_base() as conn:
            with conn.cursor() as cursor:
                ...
                if cursor.rowcount == 1:
                    ...
                    query_order = f"INSERT INTO to_order (buyer_customer_id_user,month) values ({id_user},(date_part('month', (select current_date)))); select currval('to_order_id_order_seq');"
