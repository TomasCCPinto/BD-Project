...
ALTER TABLE buyer 	  	  		ADD CONSTRAINT buyer_fk1    	 	   FOREIGN KEY (rating_id_rating) 		 	    REFERENCES rating(id_rating);
ALTER TABLE buyer 	  	  		ADD CONSTRAINT buyer_fk2    	 	   FOREIGN KEY (customer_id_user) 		 	    REFERENCES customer(id_user);
